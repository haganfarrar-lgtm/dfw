...
export const businessInfo = {
  ...
  address: {
    ...
    state: 'TX',
    zip: '76102',
    full: 'Serving the entire DFW Metroplex'
  },
  geo: {
    latitude: 32.7555,
    longitude: -97.3308
  ...
  social: {
    facebook: 'https://facebook.com/dfwlandscapingpros',
    instagram: 'https://instagram.com/dfwlandscapingpros',
    google: 'https://g.page/dfwlandscapingpros',
    yelp: 'https://yelp.com/biz/dfw-landscaping-pros',
    youtube: 'https://youtube.com/@dfwlandscapingpros'
  },
  serviceArea: 'Fort Worth, Dallas, Arlington, Plano, Irving, Garland, Grand Prairie, McKinney, Frisco, and all surrounding DFW communities',
  tagline: 'Premier Landscaping & Hardscaping Services in Dallas-Fort Worth',
  description: 'Professional landscaping, hardscaping, and outdoor living services across the entire DFW Metroplex. Expert landscape design, paver installation, irrigation, tree planting, and more.',
  yearsInBusiness: 15,
  foundingYear: 2009,
  ...
  keywords: [
    ...
    'paver installation DFW',
    'landscape design Dallas',
    'irrigation Fort Worth',
    'tree planting DFW',
  ...
  review: [
    {
      ...
      reviewBody: 'DFW Landscaping Pros transformed our backyard into an oasis. Professional team, excellent communication, and outstanding results!',
    ...
    },
    {
      ...
      reviewBody: 'Best landscaping company in the metroplex! They installed our paver patio and it looks amazing. Highly recommend!',
      reviewRating: { '@type': 'Rating', ratingValue: 5, bestRating: 5 },
    },
    {
      '@type': 'Review',
...
export const generateServiceSchema = (service: { name: string; description: string; slug: string; features?: string[] }, city?: string) => ({
  '@context': 'https://schema.org',
  '@type': 'Service',
  '@id': `${businessInfo.url}/cities/${city?.toLowerCase().replace(/ /g, '-') || 'dallas'}/services/${service.slug}`,
  name: `${service.name} in ${city || 'Dallas-Fort Worth'}, TX`,
  ...
  areaServed: {
    '@type': 'City',
    name: city || 'Dallas-Fort Worth',
    '@id': `https://en.wikipedia.org/wiki/${city || 'Dallas-Fort_Worth_metroplex'},_Texas`,
  },
  url: `${businessInfo.url}/cities/${city?.toLowerCase().replace(/ /g, '-') || 'dallas'}/services/${service.slug}`,
